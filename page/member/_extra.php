...
$sql="SELECT fullName,avata FROM meetingroom_user WHERE username='".$_SESSION['username']."'";
    ...
    echo '<img id="dimg"  height="100px"  src="data:image/jpeg;base64,' . base64_encode($result['avata']) . '"/>';
...
<h3 class="menuheader expandable">☆Register</h3>
<ul class="categoryitems">
        <li><a href="index.php?page=_register_main">Registering</a></li> 
